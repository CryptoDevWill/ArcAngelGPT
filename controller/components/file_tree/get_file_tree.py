...
def get_file_tree():
    ...
    exclude_folders = ["assets", "controller", "model", "venv", "view", "dist", "__pycache__", "modules"]
    exclude_files = ["ArcAngelAI.exe","LICENSE", "requirements.txt", "settings.json", "README.md", "main.py", "run", "_main.py", "main.spec", "mac_setup.py" ]
