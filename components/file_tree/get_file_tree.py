...
def get_file_tree():
    ...
    exclude_folders = ["ArcAngelAI.exe","assets", "components", "data", "venv", "functions", "gui", "dist", "build", "openai", "tools", "user_scripts", "utils", "screens", "__pycache__", "modules", "main.py"]
